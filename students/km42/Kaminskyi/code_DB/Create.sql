...
(
   ...
   "DELETED"            CHAR(1) CHECK ("DELETED" IN ('N', 'Y')) NOT NULL,
   CONSTRAINT PK_PHOTOS PRIMARY KEY ("STATE_NAME", "ROLE", "EMAIL", "APPLICATION_ID", "PHOTO", "DELETED")
);
...
CREATE OR REPLACE PROCEDURE DELETE_ANY_APP (app_id IN NUMBER,  RS OUT INTEGER)
IS
BEGIN
    COMMIT;
    SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
